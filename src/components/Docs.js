  ...
  return (
    ...
    <div  className='md:px-32 md:py-10 py-10 w-full items-center px-0 '>
        <div className='flex justify-start bg-gray-200 items-center rounded-full mb-5'>
            ...
            <p>Explore our Checkout code with the interactive Integration Builder. <p  className='cursor-pointer text-blue-600'>Try it now</p></p>
        ...
        <div className='flex flex-col ms-6 mb-4 md:flex-row md:w-3/5' >
            ...
            <p className='mb-4'><p  className='text-blue-800 font-semibold'>Checkout</p></p>
            <p className='mb-4'><p  className='text-blue-800 font-semibold'>Subscription</p></p>
            <p className='mb-4'><p   className='text-blue-800 font-semibold'>Invoicing</p></p>
            <p className='mb-4'><p  className='text-blue-800 font-semibold'>Donate</p></p>
            </div>
            <div>
            ...
            <p className='mb-4 text-lg md:text-lg'>Build a scalable checkout solution for web and mobile with our REST APIs & Javascript SDK</p>
            <p className='mb-4'><p  className='text-blue-800 font-semibold'>Point of Sale Solutionss</p></p>
            </div>
        ...
        <div className='flex flex-col ms-6 mb-4 md:flex-row md:w-3/5'>
            ...
            <p className='mb-4 text-lg md:text-lg'>Build a scalable checkout solution for web and mobile with our REST APIs & Javascript SDK</p>
            <p className='mb-4'><p  className='text-blue-800 font-semibold'>Build a Marketplace</p></p>
            </div>
            <div>
            ...
            <p className='mb-4 text-lg md:text-lg'>Build a scalable checkout solution for web and mobile with our REST APIs & Javascript SDK</p>
            <p className='mb-4'><p  className='text-blue-800 font-semibold'>Partners</p></p>
            <p className='mb-4'><p  className='text-blue-800 font-semibold'>Plugins</p></p>
            </div>
    ...
    <div className='flex md:ps-60 md:pe-48 w-full md:py-20 bg-yellow-500 md:mt-20 md:flex-row flex-col py-10'>
        ...
        <div className='md:ps-44 px-14'>
            ...
            <p><p  className='font-semibold text-blue-700'>Get started</p></p>
        </div>
    ...
    <div className='py-20'>
        ...
        <div className='px-14 flex flex-col mb-6 md:pe-44'> 
            ...
            <p><p  className='text-blue-700 font-semibold'>Get Started</p></p>
