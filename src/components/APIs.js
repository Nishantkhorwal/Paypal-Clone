    ...
    <div className='relative md:py-20' id='2'>
        ...
        <div className='flex flex-col w-3/4 md:w-[630px] ms-12 rounded-xl shadow-lg pb-8 mb-10 md:mb-0'>
            <div className='bg-green-400 py-10 mb-5 flex items-center justify-center rounded-t-xl'>
                <img src='work3.png' className='w-[7rem] h-[5em] ' alt=''></img>
            ...
            <p className=' ps-4 font-semibold text-blue-700 mb-3'>Rest APIs</p>
            <p className=' ps-4 font-semibold text-blue-700 mb-3'>NVP/SOAP APIs</p>
            <p className=' ps-4 font-semibold text-blue-700 mb-3'>GraphQL APIs</p>
        ...
        <div className=' mt-10 md:mt-0 ms-10 w-4/5 flex justify-start bg-gray-200 items-center rounded-full mb-5 md:w-4/5 md:ms-36 md:py-5'>
            ...
            <p>To browse PayPal SDKs, see our GitHub library. <p className='cursor-pointer text-blue-600'>Learn More</p></p>
